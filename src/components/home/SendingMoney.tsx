...
import CurrencyImage from '@/assets/Finzo-currency-2.webp'
        ...
        <section className='px-4'>
            <div className="flex flex-col md:flex-row justify-between gap-6 max-w-screen-xl m-auto md:py-20">
                <div className="flex flex-col justify-evenly gap-6 md:w-[40%] p-4 z-10">
                    ...
                    <h2 className='text-custom-black-colour text-3xl md:text-5xl font-semibold'>Sending money, easy by the default.</h2>
                ...
                <div className="relative md:w-[46%]">
                    ...
                    <Image src={paymentImage} alt='payment-image' height={300} width={450} className='border-b-8 shadow-md object-cover rounded-3xl absolute top-10 md:-left-32' />
