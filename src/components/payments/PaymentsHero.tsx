...
import heroImage1 from '@/assets/finzo-payments-hero.webp'
import heroImage2 from '@/assets/finzo-payments-hero-2.webp'
        ...
        <section className='px-4'>
            <div className="flex flex-col md:flex-row justify-between gap-6 max-w-screen-xl m-auto rounded-3xl md:pb-20 md:pt-10 ">
                <div className="flex flex-col justify-evenly gap-6 md:w-[48%] p-4 z-10">
                    <p className="text-sm bg-[#CCE8C9] text-primary-colour hover:bg-primary-colour hover:text-white px-4 py-2 rounded-md w-fit transition">PAYMENTS</p>
                    <h2 className='text-custom-black-colour text-4xl md:text-6xl font-semibold'>Complete, integrated and reliable payments</h2>
                ...
                <div className="md:w-[48%] p-4 relative">
                    ...
                    <Image src={heroImage2} alt='payment-image' height={300} width={360} className='absolute shadow-md bottom-0 w-60 md:w-auto md:bottom-10 lg:-bottom-10 object-cover rounded-3xl border-b-8' />
                </div>
            </div>
        </section>
    )
