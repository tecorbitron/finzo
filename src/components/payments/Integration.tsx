...
import CurrencyImage1 from '@/assets/Finzo-integration-1.webp'
import CurrencyImage2 from '@/assets/Finzo-integration-2.webp'
import CurrencyImage3 from '@/assets/Finzo-integration-3.webp'
    ...
    return (
        <section className='py-16 px-4'>
            <div className="flex flex-col-reverse md:flex-row justify-between gap-6 max-w-screen-xl m-auto py-20">
                ...
                <div className="flex flex-col justify-evenly md:gap-6 md:w-[46%] p-4 z-10">
                    <p className="text-sm bg-[#CCE8C9] text-primary-colour hover:bg-primary-colour hover:text-white px-4 py-2 rounded-md w-fit transition">
                        INTEGRATION
                    </p>
                    <h2 className='text-custom-black-colour text-3xl md:text-5xl font-semibold'>100+ Payments fully integrated​</h2>
